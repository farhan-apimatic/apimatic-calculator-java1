...
### <a name="calculate123_async"></a>![Method: ](https://apidocs.io/img/method.png "io.apimatic.examples.controllers.SimpleCalculator.calculate123Async") calculate123Async

> Calculates the expression using the specified operation.


```java
void calculate123Async(
...
simpleCalculator.calculate123Async(operation, x, y, new APICallBack<Double>() {
